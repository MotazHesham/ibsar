<div class="card mb-3">
    ...
    <div class="card-body">
        <p class="text-muted small mb-3">حدد موعد البدء والنهاية والأيام والساعات — يُرسَل لجميع المستفيدين المقدمين.</p>
        <div class="row">
                ...
                <div class="d-flex flex-wrap gap-3">
                    @foreach ($days as $key => $label)
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="schedule_days[]" value="{{ $key }}"
                                id="day_{{ $key }}" @checked(in_array($key, $selectedDays))>
