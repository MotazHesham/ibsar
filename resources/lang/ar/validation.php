...
return [
    ...
    'custom'      => [
        'identity_num' => [
            'regex' => 'الرقم القومي يجب ان يكون 10 ارقام',
        ],
        'phone' => [
            'regex' => 'الهاتف يجب ان يكون 10 ارقام ويبدأ ب 05',
        ],
        'password' => [
            'min' => 'الرقم السري يجب ان يكون 8 ارقام',
        ], 
    ],
    ...
    'attributes'                     => [
        'kafil_name' => 'اسم الكفيل',
        'kafil_identity_num' => 'الرقم القومي للكفيل',
        'kafil_street' => 'الشارع',
        'kafil_nearby_address' => 'العنوان المجاور',
        'kafil_phone' => 'الهاتف',
        'kafil_phone2' => 'الهاتف الثاني',
        'kafil_work_phone' => 'الهاتف العمل',
        'kafil_work_address' => 'العنوان العمل',
        'kafil_email' => 'البريد الإلكتروني',
        'kafil_work_name' => 'اسم العمل',
        'kafil_mail_box' => 'مربع البريد',
        'kafil_postal_code' => 'الرمز البريدي',
        'group_name' => 'اسم المجموعة',
        'members' => 'الأعضاء',
        'contacts' => 'الاتصالات',
        'members.*.name' => 'اسم العضو',
        'members.*.identity_number' => 'الرقم القومي للعضو',
        'contacts.*.name' => 'اسم الاتصال',
        'contacts.*.family_relationship_id' => 'العلاقة العائلية',
        'contacts.*.phone' => 'الهاتف',
        'contacts.*.identity_num' => 'الرقم القومي',
