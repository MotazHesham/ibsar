            ...
            <div class="d-flex align-items-top">
                ...
                <div class="flex-fill text-truncate">
                    <a href="javascript:void(0)"
                        onclick="showAjaxOffcanvas('{{ route(auth()->user()->is_beneficiary ? 'beneficiary.mailbox.show' : 'admin.mailbox.show') }}',{id: {{ $message->id }}}, 'right', 'mail-show-offcanvas')">
                        <p class="mb-1 fs-12 fw-medium p-2">
                            ...
                            <span class="float-end text-muted fw-normal fs-11">
                                ...
                                <span data-bs-toggle="tooltip"
                                    title="{{ $message->updated_at->format('Y-m-d H:i:s') }}">
