<div class="card custom-card">
    ...
    <div class="card-body">
        ...
        <div class="d-flex gap-5 mb-4 flex-wrap justify-content-between"> 
            ...
            @endif
            @if ($beneficiaryOrder->beneficiaryFamily)
                <div class="d-flex align-items-center gap-2"> 
                    <div>
                        <span class="d-block fs-14 fw-medium">{{ $beneficiaryOrder->beneficiaryFamily->name ?? '' }}</span>
                        <span class="fs-12 text-muted">{{ trans('cruds.beneficiaryOrder.fields.beneficiary_family') }}</span>
                    </div>
                </div>
            @endif
