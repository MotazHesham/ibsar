...
@section('content')
    @php
        $breadcrumbs = [
            ...
            ['title' => trans('global.edit') . ' ' . trans('cruds.beneficiaryCategory.title_singular'), 'url' => '#'],
        ];
    @endphp
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.beneficiary-categories.update', [$beneficiaryCategory->id]) }}"
                ...
                @include('utilities.form.text', [
                    ...
                    'isRequired' => true,
                    'value' => $beneficiaryCategory->getTranslation('name', currentEditingLang()),
                ])
