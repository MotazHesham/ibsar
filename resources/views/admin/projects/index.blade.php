...
@section('content')
    @php
        $breadcrumbs = [
            ...
            ['title' => trans('global.list') . ' ' . trans('cruds.project.title'), 'url' => '#'],
        ];
        $buttons = [
            [
                'title' => trans('global.add') . ' ' . trans('cruds.project.title_singular'),
    ...
    <div class="card">
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable w-100 datatable-Project">
                <thead>
                    <tr>
                        <th width="10"></th>
