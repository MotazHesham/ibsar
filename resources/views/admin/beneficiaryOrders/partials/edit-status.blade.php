    ...
    <li class="list-group-item p-3">
        ...
        <div class="mt-5">
            ...
            @else
                ...
                @else
                    @if ($isDynamicService && !empty($workflowContext))
                        @include($workflowContext['handler']->viewName(), [
                            'beneficiaryOrder' => $beneficiaryOrder,
                            'workflowContext' => $workflowContext,
                            'statuses' => $statuses ?? [],
                    ...
                    @else
                        <form action="{{ route('admin.beneficiary-orders.update-status', $beneficiaryOrder) }}"
                            ...
                            <input type="hidden" name="signature" id="signatureData"
                                value="{{ $beneficiaryOrder->signature ?? '' }}">
                            <div class="row">
                            ...
                            @if ($beneficiaryOrder->accept_status == 'yes')
                                <button
                                    @if (getSetting('enable_get_signature_from_beneficiary') == 'yes') data-bs-toggle="modal" data-bs-target="#signatureModal" type="button" @else type="submit" @endif
                                    class="btn btn-secondary  w-20 mt-3" name="finish" value="1">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                <div class="signature-view-container">
                                    <img src="{{ $beneficiaryOrder->signature }}" alt="Signature"
                                        class="signature-display-image"
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('admin.beneficiary-orders.signature-download', $beneficiaryOrder->id) }}"
