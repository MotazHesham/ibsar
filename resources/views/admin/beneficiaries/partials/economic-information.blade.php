                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <div
                                    class="d-flex align-items-end gap-2 justify-content-between align-items-center flex-wrap mb-3">
                                    ...
                                    <h4 class="mb-0 mt-3 fw-smeibold">
                                        {{ $beneficiary->total_incomes - $beneficiary->total_expenses }}</h4>
                                    <div class="fs-12 text-muted fw-medium">
                                        {{ trans('cruds.beneficiary.profile.net_income') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <div
                                    ...
                                    <div class="fs-12 text-muted fw-medium">
                                        {{ trans('cruds.beneficiary.profile.category') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-floating mb-3 floating-success">
                            <input type="text" class="form-control" disabled
                                value="{{ $beneficiary->total_incomes }}">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class=" col-md-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" disabled
                                value="{{ $beneficiary->accommodation_type->name ?? '' }}">
                            <label>{{ trans('cruds.beneficiary.fields.accommodation_type') }}</label>
                        </div>
                    </div>
                    @if($beneficiary->accommodation_type_id == 1)
                        <div class=" col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" disabled
                                    value="{{ $beneficiaryExpenses->accommodation_rent ?? '' }}">
                                <label>{{ trans('cruds.beneficiary.fields.accommodation_rent') }}</label>
                            </div>
                        </div>
                        <div class=" col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" disabled
                                    value="{{ $beneficiaryExpenses->accommodation_rent_late ?? '' }}">
                                <label>{{ trans('cruds.beneficiary.fields.accommodation_rent_late') }}</label>
                            </div>
                        </div>
                    @elseif($beneficiary->accommodation_type_id == 3 || $beneficiary->accommodation_type_id == 4)
                        <div class=" col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" disabled
                                    value="{{ $beneficiary->accommodation_entity->name ?? '' }}">
                                <label>{{ trans('cruds.beneficiary.fields.accommodation_entity') }}</label>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="col-md-12">
                        <div class="form-floating mb-3 floating-danger">
                            <input type="text" class="form-control" disabled
                                value="{{ $beneficiary->total_expenses }}">
                            <label>{{ trans('global.total') }}</label>
                        </div>
                    </div>
                </div>
