...
@php
    $dynamicFieldMediaUrl = auth()->user()->user_type === 'staff'
        ? route('admin.beneficiary-orders.storeMedia')
        : route('beneficiary.beneficiary-orders.storeMedia');
@endphp
