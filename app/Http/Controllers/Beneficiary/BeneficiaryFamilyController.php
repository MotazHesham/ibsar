...
use App\Http\Requests\Beneficiary\StoreBeneficiaryFamilyRequest;
use App\Http\Requests\Beneficiary\UpdateBeneficiaryFamilyRequest;
...
class BeneficiaryFamilyController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $html = view('beneficiary.families.show', compact('beneficiaryFamily'))->render();
    ...
    { 
        ...
        $html = view('beneficiary.families.create', compact('beneficiary', 'disability_types', 'family_relationships', 'health_conditions', 'marital_statuses', 'educational_qualifications'))->render();
    ...
    public function edit(Request $request)
    {
        ...
        $html = view('beneficiary.families.edit', compact( 'beneficiaryFamily', 'disability_types', 'family_relationships', 'health_conditions', 'marital_statuses', 'educational_qualifications'))->render();
