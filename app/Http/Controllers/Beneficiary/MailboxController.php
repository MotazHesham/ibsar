...
class MailboxController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!in_array(request('type'), ['inbox', 'sent', 'important', 'starred', 'trash', 'archive'])) {
            return redirect()->route('beneficiary.mailbox.index', ['type' => 'inbox']);
        }
        ...
        $totalMessages = MessageParticipant::select(DB::raw('
            ...
            COUNT(*) as total
        '))->first(); 
        return view('beneficiary.mailbox.index', compact('messages', 'totalMessages'));
    }
    ...
    { 
        ...
        return redirect()->route('beneficiary.mailbox.index');
    }
    ...
    public function show(Request $request)
    {
        ...
        $html = view('beneficiary.mailbox.show', compact('message', 'replies'))->render();
    ...
    public function loadMore(Request $request)
    {
        ...
        $html = view('beneficiary.mailbox.partials.messages', compact('messages'))->render();
